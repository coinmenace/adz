/* src/config/adzcoin-config.h.  Generated from adzcoin-config.h.in by configure.  */
/* src/config/adzcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ADZCOIN_CONFIG_H

#define ADZCOIN_CONFIG_H

/* Define if building universal (internal helper macro) */
/* #undef AC_APPLE_UNIVERSAL_BUILD */

/* Build name */
#define BUILD_NAME "Atlantica"
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Adzcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Adzcoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/adzcoincoin/adzcoincoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Adzcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Adzcoin Core 0.9.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "adzcoincore"
