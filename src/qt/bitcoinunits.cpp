...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(ADZCOIN);
    unitlist.append(mADZCOIN);
    unitlist.append(uADZCOIN);
...
QString BitcoinUnits::description(int unit)
{
    ...
    else
    {
        switch(unit)
        {
            case ADZCOIN: return QString("TestAdzcoins");
            case mADZCOIN: return QString("Milli-TestAdzcoin (1 / 1" THIN_SP_UTF8 "000)");
            case uADZCOIN: return QString("Micro-TestAdzcoin (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case duffs: return QString("Ten Nano-TestAdzcoin (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
}
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case ADZCOIN:  return 100000000;
    case mADZCOIN: return 100000;
    case uADZCOIN: return 100;
    case duffs: return 1;
...
int BitcoinUnits::decimals(int unit)
{
    switch(unit)
    {
    case ADZCOIN: return 8;
    case mADZCOIN: return 5;
    case uADZCOIN: return 2;
    case duffs: return 0;
    default: return 0;
    }
}
