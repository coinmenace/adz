...
QT_MOC_LITERAL(4, 38, 24), // "privateSendRoundsChanged"
QT_MOC_LITERAL(5, 63, 24), // "privateSentAmountChanged"
QT_MOC_LITERAL(6, 88, 19), // "advancedPSUIChanged"
QT_MOC_LITERAL(7, 108, 26) // "coinControlFeaturesChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "privateSendRoundsChanged\0"
    "privateSentAmountChanged\0advancedPSUIChanged\0"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->privateSendRoundsChanged(); break;
        case 2: _t->privateSentAmountChanged(); break;
        case 3: _t->advancedPSUIChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::privateSendRoundsChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (OptionsModel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::privateSentAmountChanged)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::advancedPSUIChanged)) {
                *result = 3;
                return;
            }
        }
